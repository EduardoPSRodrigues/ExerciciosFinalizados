...
function gerarLista() {
  urls.map((url) => {
    //Para cada url que está percorrendo, cria uma tag img e coloca essa url em SRC
    const img = document.createElement("img");
    img.setAttribute("src", url); //Ir na imagem e setar o atributo SRC e falando para colocar a informação da url

    document.getElementById("lista").appendChild(img); //Jogar os elementos da img no id lista
  });
}

//Assim que a tela abrir, carrega essa função automaticamente
